...
Enhancements:
1. Added visualization of the toroidal pulse levitating through the source point.
...
# Run simulation
# -------------------------
print("Running cylindrical HN pulse sim with levitating visualization...")
...
plt.tight_layout()
plt.savefig(os.path.join(outdir, f"probe_time_fft_{date_tag}.png"), dpi=150)
