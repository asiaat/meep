...
# ==============================================================================
# 1. Define parameters for a single case (e.g., the first taper length)
...
# We'll visualize the setup for the first taper length in your loop
Lt = 2**0 
...
# Define the waveguide taper geometry
vertices = [
...
if __name__ == '__main__':
    plt.figure(dpi=150)
    sim.plot2D()
    plt.title(f"Simulation Setup for Taper Length (Lt = {Lt} μm)")
    plt.show()
